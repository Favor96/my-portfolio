        ...
        <div class="mx-36 flex flex-col space-y-4 ">
            ...
            <div class="w-3/5 flex flex-col space-y-2 text-black-75 text-deskH6 max-sm:text-phoneH6 max-lg:text-tabH6">
                ...
                <p>
                    ...
                    l’école supérieur des affaires a été la meileur des décision que j’ai jamais prise, car cela m’a
                    aidé à trouvé ce que je pouvais faire pour le reste de ma vie.
                </p>
                <p>
                    Actuellement, j'aide des entreprises du monde entier en concevant et en codant des sites Web et des
                    applications mobiles.
                </p>
                <p>
                    J'ai eu le plaisir de travailler avec kalamar, une entreprise qui est dans le secteur informatique
                </p>
                <p>
                    En ce moment je suis basé à zanguera.
                </p>
            </div>
        </div>
    </div>
